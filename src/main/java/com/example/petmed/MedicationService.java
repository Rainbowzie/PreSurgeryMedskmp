...
public class MedicationService {
    ...
    private static List<String> gabapentinForDog(double w) {
        ...
        if (w >= 2 && w <= 3.99) {
            ...
            a.add("Gabapentin 800mg #2. Give 1 tablet by mouth the night before and morning of surgery.");
        } else if (w >= 94 && w <= 104.99) {
            a.add("Gabapentin 600mg #3. Give 1.5 tablets by mouth the night before and morning of surgery.");
    ...
    private static List<String> cereniaForDog(double w) {
        ...
        if (w < 4) {
            ...
            a.add("Cerenia 24mg #2. Give 1.5 tablets by mouth the night before surgery.");
        } else if (w <= 57.99) {
            a.add("Cerenia 24mg #2. Give 2 tablets by mouth the night before surgery.");
        } else if (w <= 72.99) {
    ...
    private static List<String> trazodoneForDog(double w) {
        ...
        if (w < 4) {
            ...
            a.add("Trazodone 50mg #3. Give 1.5 tablets by mouth the night before and morning of surgery.");
        } else if (w <= 44.99) {
            a.add("Trazodone 100mg #2. Give 1 tablet by mouth the night before and morning of surgery.");
        } else if (w <= 66.99) {
            a.add("Trazodone 100mg #3. Give 1.5 tablets by mouth the night before and morning of surgery.");
        } else if (w <= 88.99) {
